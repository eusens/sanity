...
export default function PrivacyPolicy() {
  return (
    <div className="container mx-auto px-4 py-12 prose prose-lg">
      ...
      <p>
        At <strong>our site</strong> we consider the privacy of our
        visitors to be extremely important. This privacy policy document
        describes in detail the types of personal information collected and
        recorded by <strong>[our site]</strong> and how we use it.
      </p>

      <h2>Log Files</h2>
      <p>
        Like many other websites, <strong>[our site]</strong> makes use of
        log files. These files log visitors to the site – usually a standard
        ...
        is used to analyze trends, administer the site, track users’ movement
      ...
      <p>
        ...
        the site visitor accesses or visits, and to personalize or customize our
        web page content based upon visitors' browser type or other information
      ...
      <p>
        ...
        visitors based upon their visit to <strong>[our site]</strong> and
      ...
      <p>
        ...
        <strong>[our site]</strong> and which are sent directly to your
