// app/terms-of-service/page.tsx  (App Router)
// or pages/terms-of-service.tsx (Pages Router)
  ...
  return (
    <div className="container mx-auto px-4 py-12 prose prose-lg">
      ...
      <div className="w-full mb-8">
        <Image
          src="/refund-banner.jpg" // replace with your own image path
      ...
      <p>
        ...
        carefully before using <strong>[our website]</strong> website (the
        “service”) operated by <strong>[us]</strong>.
      </p>

      <h2>Conditions of Use</h2>
      <p>
        We will provide services to you, which are subject to the conditions
      ...
      <p>
        ...
        graphics, logos) is the property of <strong>[our company]</strong> and/or its
        ...
        property of <strong>[our company]</strong>, with copyright authorship for this
        compilation by <strong>[our company]</strong>.
      </p>
      ...
      <p>
        ...
        <strong>[your location]</strong>, without regard to principles of
        conflict laws, will govern these terms of service, or any dispute of any
        sort that might come between <strong>[our company]</strong> and you, or its
      ...
      <p>
        ...
        court in <strong>[your location]</strong> and you consent to exclusive
      ...
      <p>
        ...
        <strong>[name]</strong> non-exclusive, royalty-free and irrevocable
        right to use, reproduce, publish, and modify such content throughout the
        world in any media.
      </p>
